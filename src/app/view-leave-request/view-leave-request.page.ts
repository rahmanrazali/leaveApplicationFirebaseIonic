...
@Component({
  ...
  templateUrl: './view-leave-request.page.html',
  styleUrls: ['./view-leave-request.page.scss'],
})
export class ViewLeaveRequestPage implements OnInit {
posts: any;	
...
ionViewWillEnter() {
  ...
  await this.firestore.doc("leave-request/" + id).delete();
